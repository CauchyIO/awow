...
**Priority = usage × churn** (usage ranking, Casper, 2026-07: daily-digest > setup-awow > process-transcript incl. subparts > process-workitem (aspirational) > kb-synthesize > kb-mine; never used: project-manager, the cross-team-visibility stub, awow-add/awow-reset). Never-used commands get **zero eval budget** — see §6 for what happens to them instead.
