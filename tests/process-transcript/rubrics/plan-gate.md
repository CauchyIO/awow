...
3. [plan-verbs] After `details 3`, did the run print the full details view for whichever action held plan line 3 — the draft or old/new values plus a `because:` line naming the standup source — executing nothing and re-offering the options?
