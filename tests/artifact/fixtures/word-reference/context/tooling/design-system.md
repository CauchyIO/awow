---
mode: in-repo         # absent | in-repo | external
path: "context/design-system/style-guide.html"            # in-repo  → context/design-system/style-guide.html
                      # external → e.g. ~/repos/design/cauchy-style-guide-v2.html
templates_dir: "context/design-system/templates/"   # in-repo  → context/design-system/templates/
                      # external → e.g. ~/repos/design/templates/
word_reference: "context/design-system/templates/word/reference.docx"  # in-repo  → context/design-system/templates/word/reference.docx
