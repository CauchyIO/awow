...
|---|---|---|
| [word-export-design](word-export-design.md) | **Landed** (PR #87, 2026-09-04) | Word (`.docx`) export target in `/artifact` via pandoc plus a reference doc `/design-system` registers; render mechanics extracted into the `artifact-render` skill (the deferred §3.7 of design-system-capability). CAU-1525; plan at [plans/2026-09-04-word-export.md](plans/2026-09-04-word-export.md). |
