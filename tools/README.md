...
| `session_timeline.py` | Build an interactive timeline + meta-analysis of a project's Claude Code sessions from `~/.claude/projects/` logs (no tracing needed) | Via `project-timeline`; see `guides/guide-session-timeline.html` |
