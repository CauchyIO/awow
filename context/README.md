...
| `knowledge-base/` | Durable reference — patterns, decisions, runbooks, glossary. Mining is tuned by `mining-policy.md`; the inbox is drained into here by `synthesis.md` |
| `kb-inbox/` | Committed staging for durable-knowledge candidates awaiting promotion (the capture→synthesize spine) |
