...
| [canonical-knowledge-source-routing-design](canonical-knowledge-source-routing-design.md) | **Draft** | Approved design awaiting written-spec review: reference-before-capture routing to repository/OKF, SharePoint, vector-backed, and other canonical sources without copying or write-back. |
