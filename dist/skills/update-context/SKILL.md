...
>>>>>>> 5f1d141 (CAU-1412: rename the {HUB} path token to {ANCHOR} across the .agents source, the emitter escape table, and the token lint, with {HUB} kept as the silently-accepted pre-rename spelling. Regenerate the dist payloads.)
