...
1. Determine the current PI. If `context/department/pi-plan-<PI>.md` does not exist, copy `context/department/templates/pi-plan.md` to that path and update its heading to name the actual PI; if it exists, read it.
