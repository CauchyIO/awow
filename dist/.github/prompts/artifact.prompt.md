...
when-to-use: "You need to produce a styled artifact — a presentation, blog post, one-pager, or report, as HTML, PDF or Word — that should follow the team's design system. The frequent counterpart to /design-system."
